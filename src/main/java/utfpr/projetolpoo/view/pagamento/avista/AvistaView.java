 ...
 */
package utfpr.projetolpoo.view.pagamento.avista;

/**
 *
 * @author User
 */
public class AvistaView extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AvistaView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
